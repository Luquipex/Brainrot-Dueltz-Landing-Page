...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark border-t border-primary/30 section-padding relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            <h3 className="text-2xl font-orbitron font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-4">
